/** Shared Tailwind tokens for editorial forms (Contact page + room booking modal). */
export const EDITORIAL_FIELD_CLASS =
...
export const EDITORIAL_LABEL_CLASS =
  'text-[11px] uppercase tracking-[0.22em] text-charcoal/40';
