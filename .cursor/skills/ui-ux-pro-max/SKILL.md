...
name: ui-ux-pro-max
description: >-
  Design intelligence for professional UI/UX (styles, palettes, typography, UX rules, stack hints).
  Use when designing, building, reviewing, or improving interfaces; run search.py with --design-system from project root.
---
...
## Extended Design Intelligence

### Design Thinking Workflow

Before implementing UI:

1. Identify purpose and user flow
2. Define key visual hierarchy
3. Ensure layout supports fast scanning
4. Apply existing design system
...
- Animate meaningful actions only
- Duration: 150–300ms
